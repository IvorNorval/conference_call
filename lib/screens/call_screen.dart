...
import 'package:conference_call/utils/video_config.dart';
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text(_participantIds.join(", "), style: TextStyle(fontSize: 18)),
              ),
              Row(
                mainAxisSize: MainAxisSize.min,
                children: <Widget>[
    ...
    return Container(
      ...
      child: ClipRRect(
        borderRadius: BorderRadius.only(
            bottomLeft: Radius.circular(32), bottomRight: Radius.circular(32), topLeft: Radius.circular(32), topRight: Radius.circular(32)),
        child: Container(
